  ...
  return (
    <main className="min-h-screen" style={{ background: "linear-gradient(to bottom, #240453, #000000)" }}>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <Button
          className="text-white px-8 py-6 rounded-lg text-lg font-medium transition-all shadow-lg hover:shadow-xl hover:bg-[#4c0ca6] flex items-center gap-2 mx-auto"
        >
          SIM, QUERO PARTICIPAR! <ChevronRight size={20} />
        </Button>
      </section>
